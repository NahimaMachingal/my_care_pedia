...
const Section4 = () => {
  ...
  return (
    <section className="py-12 px-4 sm:px-6 md:px-[120px] bg-white">
      <div className="container mx-auto">
        {/* Heading */}
        <div className="text-start mb-10 flex flex-col gap-2">
          <h5 className="text-xl sm:text-2xl text-[#00b3d0] font-header-serif font-bold">
            Featured Doctors
          </h5>
          <h3 className="text-2xl sm:text-4xl font-bold font-header-serif text-[#04285b] mt-2 leading-snug">
            Find Your Health Match Today
          </h3>
          <p className="text-main text-base sm:text-lg mt-2 max-w-2xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {doctors.map((doc) => (
            ...
            >
              {/* Doctor Image */}
              <div className="relative bg-gray-100 h-60 sm:h-72 w-full">
                <img
                  src={doc.img}
                  alt={doc.name}
                  className="w-full h-full object-cover"
                />
                <div className="absolute bottom-3 left-0 bg-gray-200 text-gray-800 text-xs sm:text-sm font-semibold px-3 sm:px-5 py-1 rounded-r-lg shadow">
                  Recommended
                </div>
              </div>
              ...
              <div className="p-4 flex flex-col gap-2">
                <h3 className="text-lg sm:text-2xl font-semibold text-gray-800 uppercase">
                  {doc.name}
                </h3>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-sm w-full mt-2">
        ...
        {/* Explore More */}
        <div className="mt-10 sm:mt-20 flex justify-center sm:justify-start">
          <button className="px-6 sm:px-10 py-2 rounded-full border border-[#04285b] text-[#04285b] font-semibold text-base sm:text-lg hover:bg-[#00b3d0] hover:text-white transition-colors duration-200 flex items-center gap-2">
